...
//             <span key={index} className={styles.emojiItem} onClick={() => onSelectEmoji(emoji)}>
//               {emoji}
//             </span>
//           ))}
//         </div>
...
//     }
//     try {
//       // твой бэк: toggle лайка поста
//       await $api.post(`/likes/post/${post._id}`);
//       setLikesCount(prev => prev + 1); // оптимистично
//     } catch (err) {
//       console.error('Ошибка при лайке поста:', err);
//     }
//   }, [currentUser, post._id]);

//   const handleSelectEmoji = (emoji: string) => setNewComment(prev => prev + emoji);

//   const authorObj =
//     typeof post.author === 'string' ? undefined : post.author;
...
//               <span className={styles.gradient_border}>
//                 <span className={styles.gradient_border_inner}>
//                   <img className={styles.avaImg} src={authorImage} alt="profile" />
//                 </span>
//               </span>
//               <p>
...
//   // безопасные поля из union author
//   const authorName =
//     typeof post.author === 'string' ? 'User' : post.author?.username ?? 'User';
//   const authorAvatar =
//     typeof post.author === 'string'
//       ? profilePlaceholder
//       : post.author?.profileImage || profilePlaceholder;
...
//               <span className={styles.gradient_border}>
//                 <span className={styles.gradient_border_inner}>
//                   <img className={styles.avaImg} src={authorAvatar} alt="profile" />
//                 </span>
//               </span>
//               <p>
//                 <span className={styles.user_name}>{authorName}</span>
